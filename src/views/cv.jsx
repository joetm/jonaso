...
<Row left="Publications" middle={(
      <a href="/publications"><button tabIndex={-1}>&rarr; &nbsp; See Publications</button></a>
)}
  right=""
  stretched={false}
 />
...
<Row left="Technical Skills" middle={(
    <a href={_PORTFOLIO_URL}><button tabIndex={-1}>&rarr; &nbsp; Visit my Web Development Portfolio</button></a>
)}
  right=""
  stretched={false}
 />
