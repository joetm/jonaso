...
const projects = [
  ...
  },
  {
  	...
  	description: {__html: "<p>The aim of the ID+Lab project is to make the interdisciplinary nature of the Cluster \"Image Knowledge Gestaltung\" accessible by raising awareness for existing collaborative work. Via the provision of an interactive visualization of the interdisciplinary research activities, members of the cluster can explore relations concerning research topics, research objects, used methods, research activities and publications.</p><p>The project consists of three parts - a modelling method, a modelling application and an 'enhanced publication' platform for the publication of interdisciplinary research projects. The underlying idea is that scientists can gain insights about their work through modelling: new connecting points are made explicit, showing further development possibilities for research projects and collaborations.</p>"},
  	funding: "",
  	date: "2016",
