...
const _URL = process.env.NODE_ENV === "development" ? `/artworks/json/webp-redteam.json?${cachebuster}` : `https://raw.githubusercontent.com/joetm/jonaso/master/public/artworks/json/webp-redteam.json?${cachebuster}`
