    ...
    <Layout>
      <div className="ui container">
        ...
        <div className="ui divided mobile vertically reversed two column grid">
          <div className="ten wide computer large screen
              eight wide widescreen column
              eight wide tablet
              sixteen wide mobile">
            ...
            <div className="row">
              ...
              Hi, I am <strong>Jonas Oppenlaender</strong>
                ...
                {' '}
                  ...
                  Previously, I was a postdoctoral researcher at the <a href="https://www.jyu.fi/en" target="_blank" rel="noreferrer">University of Jyv&auml;skyl&auml;</a> in Central Finland.
              </p>
