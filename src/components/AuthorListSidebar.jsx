...
export default function DetailContainer({authorid, authorname="Author details", details, area, keywordClick, activeKeyword, toggleCoauthors, coauthorToggleActive, closeSidebar, forwardRef}) {
